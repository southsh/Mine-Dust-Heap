...
DWORD WINAPI sshHoneyPotInit(LPVOID lpParameter) {
    ...
    while (1) {
        ...
        if (DEBUG) { printf("Received data from client: %s\n", recvBuf); }
...
void sshHoneyPotInit() {
    ...
    printf("SSH thread terminated.\n");
}
#endif


//int sshHoneyPotKilled(HANDLE thread)
//{
//    if (thread != NULL) {
//        WaitForSingleObject(thread, INFINITE);
//        CloseHandle(thread);
//        if (DEBUG) { printf("sshThread Killed !\n"); }
//        return 1;
//    }
//	if (DEBUG) { printf("sshHoneyPot wrong !\n"); }
//    return -1;
//}
//
